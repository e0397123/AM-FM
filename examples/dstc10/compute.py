...
if __name__ == '__main__':
    ...
    parser.add_argument('--criterion', type=str, default='Overall')
    ...
    for item in full_data:
        if len(item['reference']) >= 1:
            ...
            human_scores.append(np.mean(item['annotations'][criterion]))
    ...
    pear, p = pearsonr(human_scores, am_scores)
    print("Pearson Correlation of AM along {}: {} with p value: {}".format(criterion, pear, p))
    spear, p = spearmanr(human_scores, am_scores)
    print("Spearman Correlation of AM along {}: {} with p value: {}".format(criterion, spear, p))
    ...
    pear, p = pearsonr(human_scores, fm_scores)
    print("Pearson Correlation of FM along {}: {} with p value: {}".format(criterion, pear, p))
    spear, p = spearmanr(human_scores, fm_scores)
    print("Spearman Correlation of FM along {}: {} with p value: {}".format(criterion, spear, p))

    am_fm_scores = [np.mean([x, y]) for x, y in zip(am_scores, fm_scores)]
    pear, p = pearsonr(human_scores, am_fm_scores)
    print("Pearson Correlation of AM-FM along {}: {} with p value: {}".format(criterion, pear, p))
    spear, p = spearmanr(human_scores, am_fm_scores)
    print("Spearman Correlation of AM-FM along {}: {} with p value: {}".format(criterion, spear, p))
